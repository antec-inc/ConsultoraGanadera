    ...
    <img src="css/images/img0002.jpg" class="d-block w-100">
      <div class="container">
        <div class="carousel-caption">
          <h1>Ejemplo 2</h1>
          <p>Cras justo odio, dapibus ac facilisis in, egestas eget quam. Donec id elit non mi porta gravida at eget metus. Nullam id dolor id nibh ultricies vehicula ut id elit.</p>
          <p><a class="btn btn-lg btn-danger" href="#" role="button">Click Aqui</a></p>
        </div>
      </div>
    </div>
    <div class="carousel-item">
    <img src="css/images/img0003.jpg" class="d-block w-100">
      <div class="container">
        <div class="carousel-caption text-right">
          <h1>Otro Ejemplo</h1>
          <p>Cras justo odio, dapibus ac facilisis in, egestas eget quam. Donec id elit non mi porta gravida at eget metus. Nullam id dolor id nibh ultricies vehicula ut id elit.</p>
          <p><a class="btn btn-lg btn-primary" href="#" role="button">Ir a la galeria</a></p>
        </div>
      </div>
    </div>
    <div class="carousel-item">
...
<div class="container marketing">
  ...
  <div class="row">
    <div class="col-lg-4">
      ...
      <p><a class="btn btn-secondary" href="#" role="button">Ver Detalle &raquo;</a></p>
    </div>
    <div class="col-lg-4">
      <svg class="bd-placeholder-img rounded-circle" width="140" height="140" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid slice" focusable="false" role="img" aria-label="Placeholder: 140x140"><title>Placeholder</title><rect width="100%" height="100%" fill="#777"/><text x="50%" y="50%" fill="#777" dy=".3em">140x140</text></svg>
      <h2>Podrian ir</h2>
  ...
  <div class="row featurette">
    <div class="col-md-7">
      <h2 class="featurette-heading">Novedades<span class="text-muted"> Noticia 1</span></h2>
  ...
  <div class="row featurette">
    <div class="col-md-7 order-md-2">
      <h2 class="featurette-heading">Noticia 2 <span class="text-muted"> O lo que sea</span></h2>
      <p class="lead">Donec ullamcorper nulla non metus auctor fringilla. Vestibulum id ligula porta felis euismod semper. Praesent commodo cursus magna, vel scelerisque nisl consectetur. Fusce dapibus, tellus ac cursus commodo.</p>
    </div>
